@testset "intermodes" begin
    ...
    @testset "Types" begin
        ...
        for T in type_list
            img = T.(img_gray)
            @test_reference "References/Intermodes_Gray.png" Gray.(binarize(img, f))
        end
        ...
        for T in type_list
            img = T.(img_gray)
            @test_reference "References/Intermodes_Color3.png" Gray.(binarize(img, f))
        end
    end
