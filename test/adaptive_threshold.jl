@testset "adaptive_threshold" begin
    ...
    @testset "API" begin
        ...
        # AdaptiveThreshold
        @test AdaptiveThreshold() == AdaptiveThreshold(32, 15)
        @test AdaptiveThreshold(32, 15) == AdaptiveThreshold(window_size=32, percentage=15)
        @test_throws MethodError AdaptiveThreshold(15)

        # window_size non-positive integer
        @test_throws ArgumentError AdaptiveThreshold(-1, 15)
        @test_throws InexactError AdaptiveThreshold(32.5, 15)
        # percentage ∈ [0, 100]
        @test_throws ArgumentError AdaptiveThreshold(32, -10)
        @test_throws ArgumentError AdaptiveThreshold(32, 150)

        # binarize
        f = AdaptiveThreshold(window_size=32, percentage=15)
    ...
    @testset "Types" begin
        ...
        f = AdaptiveThreshold(window_size=8, percentage=15)
